...
<body>
	...
	<div class="container mt-2">
		...
		<form:form action="/ispact/update/actuals" method="PUT"
			...
			<table
				...
				<thead>
					...
					<tr>
						...
						<td><form:input path="character.chDesc" readonly="true" placeholder="enter character desc"/></td>
						<td><form:errors path="character" cssclass="error"></form:errors>
							</form></td>
						<td></td>
					</tr>
					<tr>
						<td>MIN MES</td>
						<td><form:input path="minMes" placeholder="enter min mes"/></td>
						<td><form:errors path="minMes" cssclass="error"></form:errors>
							</form></td>
					</tr>
					<tr>
						<td>MAX MES</td>
						<td><form:input path="maxMes" placeholder="enter max mes"/></td>
